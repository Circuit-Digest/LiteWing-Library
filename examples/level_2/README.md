...
Learn the fundamentals of drone flight control.
...
- Always fly in an open area with no obstacles
- Keep `drone.target_height` low (0.3m) while learning
- Know where `emergency_stop()` is before every flight
